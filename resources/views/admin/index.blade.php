            ...
            <div class="row flex-grow-1">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline">
                      <h6 class="card-title mb-0">New Assets</h6>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline">
                      <h6 class="card-title mb-0">New Business Context</h6>
                      <div class="dropdown mb-2">
                    ...
                    <div class="row">
                      <div class="col-6 col-md-12 col-xl-5">
                        <h3 class="mb-2">{{ $contexts->count() }}</h3>
                        <div class="d-flex align-items-baseline">
                          <p class="text-danger">
                            <span>-2.8%</span>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline">
                      <h6 class="card-title mb-0">Vulnerability patched</h6>
                      <div class="dropdown mb-2">
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline mb-2">
                  <h6 class="card-title mb-0">Monthly Vulnerabilities Reported</h6>
                  <div class="dropdown mb-2">
                ...
                <p class="text-muted">This chart shows the amount of vulnerability reported monthly.</p>
                ...
                <div class="d-flex flex-column">
                  ...
                  <a href="javascript:;" class="d-flex align-items-center border-bottom py-3">
                    ...
                    <div class="w-100">
                      ...
                      <p class="text-muted tx-13">This is awesome!</p>
                    </div>
                  </a>
                  <a href="javascript:;" class="d-flex align-items-center border-bottom py-3">
                    <div class="me-3">
