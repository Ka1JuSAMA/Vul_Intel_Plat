							...
							<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
								<div class="carousel-inner">
									<div class="carousel-item active">
										<img src="{{ asset('picture/basic_scan.png') }}" class="d-block w-100" alt="...">
									</div>
...
<pre><code class="language-markup"><script type="script/prism-html-markup">basic scan report</script></code></pre>
