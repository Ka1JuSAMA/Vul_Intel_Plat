                ...
                <div class="row">
                    ...
                    <div class="card overflow-hidden">
                        ...
                        <div class="text-center">
                            ...
                            <img src="{{ asset('') }}../assets/img/man.png" width="100" class="img-fluid rounded-circle" alt="">
                            </div>
                    ...
                    <div class="card message-bx">
                        ...
                        <div class="media mb-3 pb-3 border-bottom">
                            ...
                            <img src="{{ asset('') }}../assets/img/hacker.png" alt="" class="rounded-circle img-1">
                        ...
                        <div class="media mb-3 pb-3 border-bottom">
                            <div class="image-bx me-sm-4 me-2">
                            <img src="{{ asset('') }}../assets/img/gamer.png" alt="" class="rounded-circle img-1">
                            </div>
                            <div class="media-body d-sm-flex justify-content-between d-block align-items-center">
                            <div class="me-sm-3 me-0">
                        ...
                        <div class="media">
                            <div class="image-bx me-sm-4 me-2">
                            <img src="{{ asset('') }}../assets/img/man (1).png" alt="" class="rounded-circle img-1">
                            <span class="active"></span>
                            </div>
                            <div class="media-body d-sm-flex justify-content-between d-block align-items-center">
                            <div class="me-sm-3 me-0">
                    ...
                    <div class="card kanbanPreview-bx">
                        ...
                        <div class="sub-card">
                            ...
                            <ul class="users col-6">
                                <li><img src="{{ asset('') }}../assets/img/man (1).png" alt=""></li>
